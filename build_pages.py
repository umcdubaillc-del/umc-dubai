...
FLEET_PAGES_DRAFT = [
  {"id":"bmw-7",
   ...
   # v93: mobile-only crop re-tuned at 402px live against phone screenshots.
   # Lower X moves the visible window left so the car's front lands in the
   # centre of the frame instead of clipping off the right edge.
   "hero_object_pos_mobile":"40% 32%",
  ...
  {"id":"luxury-coach",
   ...
   # v93: mobile-only crop re-tuned at 402px live against phone screenshots.
   # Lower X centres the coach front in the frame; the previous 62% still
   # showed too much right-side bias.
