...
FLEET_PAGES_DRAFT = [
  {"id":"bmw-7",
   ...
   # v92: mobile-only crop re-tuned at 402px live; pulled back from 65% to
   # 55% (was too far right). Car sits centred-right with roofline at top.
   "hero_object_pos_mobile":"55% 32%",
  ...
  {"id":"luxury-coach",
   ...
   # v92: mobile-only crop re-tuned at 402px live; pulled back from 68% to
   # 62% (was slightly too far right). Coach centred horizontally, sky trimmed.
   "hero_object_pos_mobile":"62% 50%",
