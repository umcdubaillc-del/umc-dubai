...
<section class="hero" id="book">
  <div class="wrap">
    <div class="hero-grid">
      <div>
        <div class="route-eyebrow" aria-hidden="true">
          <span class="dot"></span><span class="dash"></span>
          <span class="lbl" style="letter-spacing:.34em;white-space:nowrap">Across All Seven Emirates</span>
          <span class="dash"></span><span class="dot" style="background:transparent;border:1.5px solid var(--amber)"></span>
        </div>
        <h1>Luxury chauffeur service in Dubai</h1>
        <p class="lede">The standard for private travel in the Emirates. Planned in advance, driven with discretion, on time without exception.</p>
        ...
        <div class="trust icons">
          <span><svg viewBox="0 0 24 24"><path d="M12 2l3.1 6.3 6.9 1-5 4.9 1.2 6.8L12 17.8 5.8 21l1.2-6.8-5-4.9 6.9-1z"/></svg><b>5.0</b>&nbsp;on Google, every review five stars</span>
          <span><svg viewBox="0 0 24 24"><path d="M12 2l8 4v6c0 5-3.5 8.5-8 10-4.5-1.5-8-5-8-10V6z"/></svg>Vetted, professional chauffeurs</span>
          <span><svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="9"/><path d="M12 7v5l3 3"/></svg>A concierge desk that answers at any hour</span>
        </div>
      </div>
      <div class="hero-photo">
        <img src="https://images.unsplash.com/photo-1613033686399-aa7c18d6d760?q=80&w=900&h=1130&fit=crop&auto=format" alt="Mercedes-Benz S-Class at night — UMC Dubai luxury chauffeur service" fetchpriority="high" width="900" height="1130">
      </div>
    </div>
  </div>

  <figure class="frame wrap rv">
    <img src="https://images.unsplash.com/photo-1613033686399-aa7c18d6d760?q=80&w=1600&h=900&fit=crop&auto=format" alt="Mercedes-Benz S-Class at night — UMC Dubai" width="1600" height="900">
    <figcaption class="lbl">The standard, not the exception</figcaption>
  </figure>
</section>
...
<section class="sec">
  <div class="wrap">
    <div class="shead rv"><span class="lbl">Services</span><h2>Arranged around your day.</h2></div>
    <div class="svc-rows rv">
      <a href="airport-transfers.html"><div><h3>Airport transfers</h3><p>Met in the arrivals hall and driven without delay. The flight is tracked so the car is never early or late.</p></div><span class="arr">&rarr;</span></a>
      <a href="corporate.html"><div><h3>Corporate chauffeur</h3><p>Executive accounts with consolidated invoicing and booking on behalf of guests.</p></div><span class="arr">&rarr;</span></a>
      <a href="booking.html"><div><h3>By the hour</h3><p>A car and chauffeur held at your disposal for five hours, ten hours or the length of a visit.</p></div><span class="arr">&rarr;</span></a>
      <a href="inter-emirate.html"><div><h3>Inter-emirate transfers</h3><p>Dubai to Abu Dhabi and every emirate beyond. One car and one chauffeur, door to door.</p></div><span class="arr">&rarr;</span></a>
      <a href="contact.html"><div><h3>Events &amp; groups</h3><p>From a single S-Class to a 55-seat coach, coordinated to the minute.</p></div><span class="arr">&rarr;</span></a>
    </div>
  </div>
</section>
...
<section class="sec">
  <div class="wrap">
    <div class="quote rv">
      <span class="lbl" style="display:block;margin-bottom:1.4rem">Client words</span>
      <blockquote>&ldquo;From pick-up to drop-off the experience was top notch and of ultimate luxury. Very punctual, and the whole process was extremely smooth. Will definitely book again.&rdquo;</blockquote>
      <cite>Abe &mdash; one of many five-star Google reviews</cite>
      <div style="margin-top:1.6rem"><a class="btn-line" target="_blank" rel="noopener" href="https://www.google.com/search?q=UMC+Dubai+reviews">Read reviews on Google</a></div>
    </div>
  </div>
</section>
  ...
  <div class="wrap">
    ...
    <div class="scen rv">
      <div class="sc"><svg viewBox="0 0 24 24"><path d="M21 15.5l-8-3V5.2a1.7 1.7 0 0 0-3.4 0v7.3l-6.6 2.5v2l6.6-1.4v3.6L7.5 21v1.4l4.8-1 4.8 1V21l-2.1-1.8v-3.6l6 1.3z"/></svg>
        ...
        <div class="pick"><a href="booking.html?vehicle=s-class">S-Class</a><a href="booking.html?vehicle=bmw-7">BMW 7</a><a href="booking.html?vehicle=escalade">Escalade</a></div></div>
    ...
    <div class="bk-layout">
      ...
      <div class="bk-card">
        <div class="chatcard rv" aria-hidden="true">
          ...
          <div class="bub in">Landing at DXB T3 at 23:40 tonight &mdash; book an S&#8209;Class for my transfer.</div>
          <div class="bub out">Your chauffeur will be waiting at arrivals with a name board at 23:40. We are tracking EK 004 &mdash; written confirmation follows here.</div>
